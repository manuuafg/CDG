  ...
  <div class="contenedor">
    ...
    <form id="formulario-dolar" method="post" action="?respdolar=guardarPrecio">
      <div>
        ...
        <button type="submit" class="btn-3">INGRESAR</button>
        <br>
        <!-- Botón para cancelar y enlace para generar reporte de precios -->
        <button type="button" onclick="history.back();" class="btn-3">Cancelar</button>
      </div>
      <br>
      <a href="Reportes/reporte_preciosD.php" class="btn-3">Generar Reporte de Precios</a>
    </form>
  </div>
